...
void TestSnapshotTimelineModel::testSetThumbnails() {
    ...
    QVector<int> indices = { 100, 101, 102 };
    ...
    QCOMPARE(m_model->data(m_model->index(1), SnapshotTimelineModel::IndexRole).toInt(), 101);
